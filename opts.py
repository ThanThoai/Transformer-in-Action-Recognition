...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='/vinbrain/hoang/Action_Recognition/Action_Detection_G_CV/annotation_Climbing/climb_ver15.json', type=str, help='Annotation file path')
    parser.add_argument('--result_path', default='exp_28_12', type=str, help='Result directory path')
    parser.add_argument('--store_name', default='model', type=str, help='Name to store checkpoints')
    parser.add_argument('--dataset', default='jester', type=str, help='Used dataset (activitynet | kinetics | ucf101 | hmdb51)')
    parser.add_argument('--num_classes', default=2, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
    parser.add_argument('--n_finetune_classes', default=2, type=int, help='Number of classes for fine-tuning. n_classes is set to the number when pretraining.')
    parser.add_argument('--sample_duration', default=16, type=int, help='Temporal duration of inputs')
    parser.add_argument('--downsample', default=3, type=int, help='Downsampling. Selecting 1 frame out of N')
    ...
    parser.add_argument('--lr_steps', default=[10, 20, 30, 40], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
    ...
    parser.add_argument('--pretrain', default='', type=str, help='Pretrained model (.pth)')
    ...
    parser.add_argument('--model', default='timesformer', type=str, help='(timesformer | vivit')
    ...
    parser.add_argument('--conv_type', default='Conv2d', type=str)
    parser.add_argument('--tube_size', default=2, type=int)
    parser.add_argument('--n_crops', default=1, type=int)
